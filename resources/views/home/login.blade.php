					...
					<div class="m-login__contanier">
						...
						<div class="m-login__signup">
							...
							<form class="m-login__form m-form" action="">
								...
								<div class="form-group m-form__group">
									<input class="form-control m-input" type="password" placeholder="Confirm Password" name="password">
								</div>			
								<div class="form-group m-form__group mb-3">
									<input class="form-control m-input" type="text" placeholder="University" name="fullname">
								</div>
								<div class="form-group m-form__group mt-3 mb-3">
									<label for="exampleSelect1">Batch</label>
									<select class="form-control m-input mt-3 mb-3" id="exampleSelect1">
										<option>1</option>
										<option>2</option>
										<option>3</option>
										<option>4</option>
								...
								<div class="form-group m-form__group">
									<label for="exampleSelect1" placeholder="">Primary Trainer</label>
									<select class="form-control m-input" id="exampleSelect1">
										<option>1</option>
										<option>2</option>
										<option>3</option>
